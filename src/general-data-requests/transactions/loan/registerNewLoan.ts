import { Int, Table, VarChar, Transaction, Bit, Float, DateTime } from 'mssql';
...
export const registerNewLoan = async (
    ...
    try {
        ...
        tableLoanHeaderBD.columns.add('CANTIDAD_PRESTADA', Float, { nullable: false })
        tableLoanHeaderBD.columns.add('DIA_SEMANA', VarChar, { nullable: false })
        tableLoanHeaderBD.columns.add('FECHA_INICIAL', DateTime, { nullable: false })
        tableLoanHeaderBD.columns.add('FECHA_FINAL_ESTIMADA', DateTime, { nullable: false })
        tableLoanHeaderBD.columns.add('FECHA_FINAL_REAL', DateTime, { nullable: false })
        tableLoanHeaderBD.columns.add('ID_COBRADOR', Int, { nullable: false })
        tableLoanHeaderBD.columns.add('CANTIDAD_RESTANTE', Float, { nullable: true })
        ...
        tableLoanDetailBD.columns.add('FECHA_VENCIMIENTO', DateTime, { nullable: false })
        ...
        tableLoanDetailBD.columns.add('MODO_INSERCION', VarChar, { nullable: true })
